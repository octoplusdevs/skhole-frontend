    ...
    lessons: [
      {
        ...
        watched: false,
        description:
          "O que é HTML Tags mais comuns, Estrutura básica de um documento Boas práticas iniciais O que é HTML Tags mais comuns, Estrutura básica de um documento Boas práticas iniciais",
      },
      {
        id: 1,
