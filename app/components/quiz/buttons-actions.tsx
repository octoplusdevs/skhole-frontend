import { Lightbulb, PaperPlane } from "@phosphor-icons/react/dist/ssr"
import { Button } from "../ui/button"
import { IButttonActions } from "./interface"
...
const ButtonsActions = ({
  ...
  return (
    <div className="flex gap-4 sm:w-fit w-full h-[50px]">
      <Button
        disabled={isLoading}
        className={`flex w-fit px-[32px] border-none items-center rounded-[4px] text-[16px]
      ...
      {hint.length != 0 && (
        <Button
          ...
          className={`flex w-fit bg-transparent rounded-[4px] items-center border border-[#FDB447]
