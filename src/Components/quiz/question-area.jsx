  ...
  return(
    <div className="flex flex-col gap-8">
      <div className="flex gap-4 w-max p-3 bg-[#262626] rounded-[6px]">
        <span className="text-white text-[18px] font-medium ">+1</span>
        <Lightning size={24} color="#69DB7C" />
      </div>

      <p className="text-white text-[18px] font-medium">
        Qual ferramenta e bastante usada para versionamento de codigo?
      </p>
      ...
      <div className="flex flex-col sm:flex-row gap-8 sm:gap-4">
        ...
        >
          <Input
            className="font-semibold placeholder:font-light text-[18px] text-[#7D7D7D]
            placeholder:text-[#777777] border-none py-11 pl-8  w-full"
            placeholder="Formato da resposta: "
            onChange={(e)=> hideResponseFormat(e)}
          />
          <span
            className={`text-white font-semibold absolute left-[212px] top-[14px]
            ${focusInput ? 'hidden': 'flex'}`}
          >
            ***
          </span>
        </div>
      ...
      <div className="flex gap-4 w-full max-w-[348px] sm:max-w-[248px]">
        ...
        className="flex w-full border-none items-center rounded-[4px] text-2xl
          text-white bg-[#845EF7] gap-2 h-[56px] hover:bg-[#845ef7ee]"
        >
          <PaperPlane size={24} color="#fff" className="rotate-45 translate-y-[-4px]"/>
          Enviar
        </Button>
        ...
        <Button
          ...
          className="flex w-full max-w-[111px] rounded-[4px] items-center border
            border-[#FDB447] gap-2 text-2xl text-[#FDB447] justify-center h-[57px]"
        >
